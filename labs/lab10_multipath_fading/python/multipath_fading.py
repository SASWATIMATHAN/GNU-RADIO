...
# Title: MULTIPATH FADING - 2 RAY WIRELESS MODEL
...
class multipath_fading(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "MULTIPATH FADING - 2 RAY WIRELESS MODEL", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MULTIPATH FADING - 2 RAY WIRELESS MODEL")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "multipath_fading")
        ...
        self.gain_2 = gain_2 = 0.7
        self.gain_1 = gain_1 = 1
        self.delay_2 = delay_2 = 1500
        self.delay_1 = delay_1 = 80
        self.avg = avg = 0.2
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(0.4)
    ...
    def set_delay_2(self, delay_2):
        ...
        self.blocks_delay_0_0.set_dly(int(self.delay_2))
...
def main(top_block_cls=multipath_fading, options=None):
