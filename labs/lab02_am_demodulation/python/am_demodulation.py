...
class am_demodulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AM DEMODULATION", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "am_demodulation")
        ...
        self._volume_range = qtgui.Range(0, 0.05, 0.001, 0.02, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 5000, 500, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=am_demodulation, options=None):
