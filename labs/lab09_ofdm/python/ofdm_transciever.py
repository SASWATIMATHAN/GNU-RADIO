...
# Description: OFDM transceiver for audio/file transmission using GNU Radio
...
class ofdm_transciever(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ofdm_transciever")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\hp\\Downloads\\GNU RADIO\\SAM AUDIO.mp3', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\hp\\Downloads\\GNU RADIO\\result.mp3', False)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_2_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_multiply_xx_2, 0))
        self.connect((self.analog_sig_source_x_2_0, 0), (self.blocks_multiply_xx_2_0, 1))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_multiply_xx_2, 1))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_multiply_xx_2_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_2, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.blocks_multiply_xx_2_0, 0), (self.blocks_float_to_complex_0, 1))
...
def main(top_block_cls=ofdm_transciever, options=None):
