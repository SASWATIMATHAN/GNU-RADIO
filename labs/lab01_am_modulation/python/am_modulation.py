...
class am_modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "am_modulation")
        ...
        self._fc_range = qtgui.Range(5000, 100000, 100, 10000, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self._fm_range = qtgui.Range(1000, 10000, 100, 5000, 200)
        ...
        self.dc_blocker_xx_0 = filter.dc_blocker_ff(32, False)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_abs_xx_0, 0))
